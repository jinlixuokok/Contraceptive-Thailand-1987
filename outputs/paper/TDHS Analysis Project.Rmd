...
library(tidyverse)
library(reshape2)
cleaned_data <- read_csv("/cloud/project/outputs/data/cleaned_data.csv")
...
```{r child='/cloud/project/inputs/data/datasheet_template.Rmd'}
